 	...
 	<div class="generic-container">
		...
		<div class="well lead">User Registration Form</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="ssoId">Employee ID</label>
					<div class="col-md-7">
						<c:choose>
							<c:when test="${id}">
		...
		<%-- 	<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="userGroup">Roles</label>
					<div class="col-md-7">
						<form:select path="userGroup" items="${userGroup}" multiple="true" itemValue="name" itemLabel="type" class="form-control input-sm" />
						<div class="has-error">
